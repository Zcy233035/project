...
public class Tileset {
    public static final TETile AVATAR = new TETile('W', Color.white, Color.black, "you", 0);
    public static final TETile AVATAR2 = new TETile('Z', Color.white, Color.black, "you2", 13);
    ...
    public static final TETile TREE = new TETile('♠', Color.yellow, Color.black, "coin", 11);
